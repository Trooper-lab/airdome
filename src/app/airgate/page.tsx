...
export default function LandingPage() {
  ...
  const handleFetchBrand = (e?: React.FormEvent) => {
    ...
    router.push(`/airgate/design?brand=${encodeURIComponent(brandQuery.trim())}`);
  };
  ...
  return (
    <div ref={containerRef} className="min-h-screen bg-[#0A0A0A] font-spline selection:bg-white selection:text-black pb-0">


      {/* Unified Cinematic Hero-to-Showcase Experience */}
      <div ref={showcaseRef} className="relative h-[400vh] bg-[#0A0A0A]">
        ...
        <div className="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="hero-massive-text absolute top-[15%] left-0 w-full flex justify-center pointer-events-none z-10 select-none">
            <h2 className="font-syne font-extrabold text-[12vw] sm:text-[15vw] leading-none text-white tracking-[-0.04em] uppercase opacity-0">
              Airgate<span className="text-[0.3em] align-top ml-1">®</span>
            </h2>
          </div>
          ...
          <div className="hero-content-layer relative z-[50] w-full h-full flex flex-col items-center justify-center text-center px-6">
            <div className="trusted-by opacity-0 w-full max-w-5xl mb-12">
              ...
              <div className="relative h-12 flex justify-center items-center">
                 {[
                   ...
                   { src: "https://upload.wikimedia.org/wikipedia/en/thumb/4/4b/HelloFresh_logo.svg/1200px-HelloFresh_logo.svg.png", alt: "HelloFresh", h: "h-7 md:h-8" },
                   { src: "/logos/mclaren.svg", alt: "McLaren", h: "h-4 md:h-5" },
                   { src: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/07/Canon_logo.svg/1200px-Canon_logo.svg.png", alt: "Canon", h: "h-5 md:h-6" },
                   ...
                   { type: "text", content: "+1,500 brands" }
                    ...
                    <div key={i} className="logo-item absolute inset-0 flex items-center justify-center opacity-0 overflow-hidden">
                      {logo.type === "text" ? (
                        <div className="text-[12px] md:text-sm font-bold bg-white/5 rounded-full px-5 py-2 text-white border border-white/10">
                          {logo.content}
                        </div>
                      ) : (
            ...
            <h1 className="hero-title opacity-0 translate-y-10 text-4xl sm:text-5xl md:text-[76px] font-bold leading-[1.05] mb-6 font-spline tracking-[-0.03em] max-w-4xl text-white">
              {t("hero.headline")}
            </h1>
              ...
              <div className="flex flex-col items-center gap-8 w-full max-w-[540px]">
                ...
                <div className="relative w-full group">
                  ...
                  <form 
                    ...
                    className="w-full relative z-[60] flex items-center bg-white/5 backdrop-blur-md border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.2)] rounded-[24px] overflow-hidden focus-within:border-white focus-within:shadow-[0_25px_60px_rgba(0,0,0,0.3)] transition-all duration-500"
                  >
                    <div className="absolute left-6 text-gray-400 group-focus-within:text-white transition-colors pointer-events-none">
                    ...
                    <button 
                      ...
                      className="absolute right-2 px-6 py-3.5 bg-white text-black text-[13px] font-bold uppercase tracking-widest rounded-2xl hover:bg-gray-200 transition-all active:scale-95 disabled:opacity-30 disabled:pointer-events-none"
                    >
                      {isRedirecting ? (
            ...
            <div className="flex-1 relative h-full flex flex-col justify-end pb-[15vh] md:justify-center md:pb-0 items-start lg:pl-24 pointer-events-auto z-[90]">
              <div className="step-1 absolute inset-0 flex flex-col justify-end pb-[15vh] md:justify-center md:pb-0 opacity-0 translate-y-8 z-[91]">
                ...
                <div className="flex items-start gap-4 mb-6">
                  <div className="mt-1.5 shrink-0 w-10 h-10 rounded-xl border border-white/10 bg-white/5 flex items-center justify-center">
              ...
              <div className="step-3 absolute inset-0 flex flex-col justify-end pb-[15vh] md:justify-center md:pb-0 opacity-0 translate-y-8 z-[93]">
                ...
                <div className="relative mt-10 z-[100]">
                  <Link 
                    href="/airgate/design"
                    className="flex px-12 py-5 bg-white text-black font-bold rounded-full w-fit hover:bg-gray-200 transition-all active:scale-95 shadow-2xl relative"
                  >
                    {t("airgate.hero.cta")}
                  </Link>
                </div>
      ...
      <section className="py-24 px-6 max-w-7xl mx-auto flex flex-col lg:flex-row items-start gap-16 lg:gap-24">
        <div className="flex-1 space-y-10">
          <div className="space-y-6">
            <h2 className="text-4xl md:text-5xl font-spline font-bold leading-tight text-white max-w-lg">
              {t("roi.headline")}
            </h2>
          ...
          <div className="relative group overflow-hidden rounded-[40px] border border-gray-100 shadow-2xl">
            <img 
              src="/images/Volvo-Airgate-details.jpg" 
              alt="Volvo Airgate Details" 
        ...
        <div className="flex-1 w-full bg-white/5 backdrop-blur-md rounded-[40px] p-6 md:p-12 border border-white/10 shadow-lg sticky top-24">
          <div className="grid grid-cols-2 gap-4 pb-4 border-b border-white/10 mb-8">
            <div className="font-spline font-bold text-gray-400 uppercase tracking-wider text-xs">{t("roi.col1")}</div>
            <div className="font-spline font-bold text-white uppercase tracking-wider text-xs">{t("roi.col2")}</div>
          </div>
            ...
            {[
              ...
              { label: t("roi.transport"), val1: t("roi.transport1"), val2: t("roi.transport2") }
               ...
               <div key={i} className="grid grid-cols-2 gap-6 items-center">
                 ...
                 <div className={`font-bold text-sm md:text-lg ${row.highlight ? "text-green-500" : "text-white"}`}>
                   {row.val2}
                 </div>
               </div>
            ))}
      ...
      <section className="py-40 px-6 max-w-6xl mx-auto">
        <div className="mb-32">
          ...
          <h2 className="text-5xl md:text-7xl font-spline font-bold text-white tracking-tight leading-[1.05] max-w-4xl">
            Trusted by global leaders to <span className="text-gray-500">own the space.</span>
          </h2>
        </div>
        ...
        <div className="space-y-40">
          {[
            ...
            { 
             ...
             <div key={i} className="review-card flex flex-col md:flex-row gap-12 md:gap-24 opacity-0 scale-95 translate-y-20 bg-white/5 backdrop-blur-sm p-8 md:p-12 rounded-[32px] border border-white/10">
               <div className="md:w-1/3">
                 <img src={tLine.logo} alt={tLine.brand} className="h-10 md:h-12 w-auto mb-8 object-contain brightness-0 invert opacity-80" />
                 <div className="h-px w-12 bg-white/10 mb-8" />
                 <div className="font-bold text-sm tracking-tight text-white">{tLine.name}</div>
                 <div className="text-[12px] text-gray-400 font-medium mt-1 uppercase tracking-tight">{tLine.role}</div>
               </div>
               <div className="md:w-2/3">
                 <p className="text-2xl md:text-4xl font-spline font-light leading-[1.15] text-white tracking-tight">
                   "{tLine.quote}"
                 </p>
               </div>
             </div>
