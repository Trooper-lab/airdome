...
export default function Home() {
  ...
  const renderStep = () => {
    switch (step) {
      ...
      case 2:
        return <Step2_Personality onContinue={(val) => updateSelection("personality", val)} />;
      case 3:
        return <Step3_Vibe onContinue={(val) => updateSelection("vibe", val)} />;
      case 4:
        return <Step4_Size onContinue={(val) => updateSelection("size", val)} />;
      case 5:
        return <Step5_Config onContinue={(val) => updateSelection("config", val)} />;
      case 6:
        return <Step6_Event onContinue={(val) => updateSelection("event", val)} />;
      case 7:
