...
export const Step3_Vibe: React.FC<{
  ...
  const options = [
    { id: "v1", name: t("design.s3.v1") as string, hint: t("design.s3.v1.hint") as string, badge: t("design.s3.v1.badge") as string },
    { id: "v2", name: t("design.s3.v2") as string, hint: t("design.s3.v2.hint") as string },
    { id: "v3", name: t("design.s3.v3") as string, hint: t("design.s3.v3.hint") as string },
    { id: "v4", name: t("design.s3.v4") as string, hint: t("design.s3.v4.hint") as string },
  ];

  return (
    <QuestionScreen
      phase={t("design.s3.phase") as string}
      title={<>{t("design.s3.title")}</>}
      subtitle={t("design.s3.subtitle") as string}
