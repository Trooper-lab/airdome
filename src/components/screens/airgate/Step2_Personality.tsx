...
export const Step2_Personality: React.FC<{
  ...
  const options = [
    { id: "rebel",    name: t("airgate.design.s2.rebel")    as string, ref: t("airgate.design.s2.rebel.ref")    as string, num: "01" },
    { id: "bold",     name: t("airgate.design.s2.bold")     as string, ref: t("airgate.design.s2.bold.ref")     as string, num: "02" },
    { id: "clean",    name: t("airgate.design.s2.clean")    as string, ref: t("airgate.design.s2.clean.ref")    as string, num: "03" },
    { id: "premium",  name: t("airgate.design.s2.premium")  as string, ref: t("airgate.design.s2.premium.ref")  as string, num: "04" },
    { id: "friendly", name: t("airgate.design.s2.friendly") as string, ref: t("airgate.design.s2.friendly.ref") as string, num: "05" },
    { id: "other",    name: t("airgate.design.s2.other")    as string, ref: t("airgate.design.s2.other.ref")    as string, num: "06" },
  ];

  return (
    <QuestionScreen
      phase={t("airgate.design.s2.phase") as string}
      title={<>{t("airgate.design.s2.title")}</>}
      subtitle={t("airgate.design.s2.subtitle") as string}
