  ...
  return (
    <div ref={ref} className="flex flex-col items-center justify-center min-h-[420px] text-center px-4">
      ...
      <div className="s8-success opacity-0 text-[10px] tracking-[0.3em] text-gray-400 uppercase mb-3">
        {t("airgate.design.s8.success.eyebrow")}
      </div>
      <h2 className="s8-success opacity-0 font-syne font-extrabold text-[36px] md:text-[44px] text-white tracking-tight leading-[1.05] mb-4 max-w-[420px]">
        {brandName
          ? (t("airgate.design.s8.success.title.brand") as string).replace("{brand}", brandName)
          : t("airgate.design.s8.success.title")}
      </h2>
      <p className="s8-success opacity-0 text-gray-400 text-[15px] leading-relaxed max-w-[320px] mb-8">
        {t("airgate.design.s8.success.subtitle")}
      </p>
      {/* Timeline */}
        ...
        {([
          {
            ...
            label: t("airgate.design.s8.success.t1")
          },
          {
            icon: (
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            label: t("airgate.design.s8.success.t2")
          },
          {
            icon: (
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            label: t("airgate.design.s8.success.t3")
          },
        ] as any[]).map((item, i) => (
...
const SummaryPills: React.FC<{ selections: any }> = ({ selections }) => {
  ...
  const pills = [
    ...
    selections?.event && { label: t(`airgate.design.s6.${selections.event}`) as string, key: "event" },
    selections?.urgency && { label: t(`airgate.design.s7.${selections.urgency}`) as string, key: "urgency" },
...
export const Step8_Lead: React.FC<{
  ...
  const headline = brandName
    ? (t("airgate.design.s8.title.brand") as string).replace("{brand}", brandName)
    : t("airgate.design.s8.title") as string;

  return (
    <QuestionScreen
      phase={t("airgate.design.s8.phase") as string}
      title={<>{headline}</>}
      subtitle={t("airgate.design.s8.subtitle") as string}
      canContinue={true}
      hideButton={true}
      onContinue={() => {}}
      onBack={onBack}
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-[420px] space-y-3 mx-auto">
        ...
        <div className="relative">
          <input
            ...
            placeholder={t("airgate.design.s8.placeholder") as string}
          ...
          >
            {isSubmitting ? "..." : t("airgate.design.s8.button")}
          </button>
        </div>
          ...
          {[
            {
              ...
              stat: t("airgate.design.s8.stat1")
            },
            {
              icon: (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              stat: t("airgate.design.s8.stat2")
            },
            {
              icon: (
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              stat: t("airgate.design.s8.stat3")
            },
          ].map((item: any, i) => (
