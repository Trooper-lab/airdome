...
export const Step6_Event: React.FC<{
  ...
  const options = [
    { id: "racing",   name: t("airgate.design.s6.racing") as string,   hint: t("airgate.design.s6.racing.hint") as string },
    { id: "trade",    name: t("airgate.design.s6.trade") as string,    hint: t("airgate.design.s6.trade.hint") as string },
    { id: "festival", name: t("airgate.design.s6.festival") as string, hint: t("airgate.design.s6.festival.hint") as string },
    { id: "sampling", name: t("airgate.design.s6.sampling") as string, hint: t("airgate.design.s6.sampling.hint") as string },
    { id: "brand",    name: t("airgate.design.s6.brand") as string,    hint: t("airgate.design.s6.brand.hint") as string },
    { id: "other",    name: t("airgate.design.s6.other") as string,    hint: t("airgate.design.s6.other.hint") as string },
  ];

  return (
    <QuestionScreen
      phase={t("airgate.design.s6.phase") as string}
      title={<>{t("airgate.design.s6.title")}</>}
      subtitle={t("airgate.design.s6.subtitle") as string}
      onBack={onBack}
