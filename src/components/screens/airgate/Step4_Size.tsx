...
const sizes = (t: Function) => [
  {
    id: "3x3",   label: "3 × 3 m",    sub: t("airgate.design.s4.compact")   as string,
    s: 18, multi: false, dim: "3m", sqm: "9 m²"
  },
  {
    id: "4x4",   label: "4 × 4 m",    sub: t("airgate.design.s4.standard")  as string,
    s: 22, multi: false, dim: "4m", sqm: "16 m²"
  },
  {
    id: "5x5",   label: "5 × 5 m",    sub: t("airgate.design.s4.large")     as string,
    s: 27, multi: false, dim: "5m", sqm: "25 m²"
  },
  {
    id: "6x6",   label: "6 × 6 m",    sub: t("airgate.design.s4.xl")        as string,
    s: 32, multi: false, dim: "6m", sqm: "36 m²"
  },
  {
    id: "multi", label: "Multiple",    sub: t("airgate.design.s4.connected") as string,
    s: 22, multi: true,  dim: "×2+", sqm: "50+ m²"
  },
  {
    id: "unsure", label: t("airgate.design.s4.notSure") as string, sub: t("airgate.design.s4.advise") as string,
...
export const Step4_Size: React.FC<{
  ...
  return (
    <QuestionScreen
      phase={t("airgate.design.s4.phase") as string}
      title={<>{t("airgate.design.s4.title")}</>}
      subtitle={t("airgate.design.s4.subtitle") as string}
    ...
    >
      ...
      <div className="mt-5 flex items-center gap-2 px-1">
        ...
        <p className="text-[10px] text-gray-500">{t("airgate.design.s4.note") as string}</p>
      </div>
    </QuestionScreen>
  );
};
