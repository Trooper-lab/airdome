...
export const Step5_Config: React.FC<{
  ...
  const options = [
    { id: "w0", name: t("airgate.design.s5.w0") as string, hint: t("airgate.design.s5.w0.hint") as string, image: TENT_IMAGES[0] },
    { id: "w1", name: t("airgate.design.s5.w1") as string, hint: t("airgate.design.s5.w1.hint") as string, image: TENT_IMAGES[1] },
    { id: "w2", name: t("airgate.design.s5.w2") as string, hint: t("airgate.design.s5.w2.hint") as string, image: TENT_IMAGES[2] },
    { id: "w3", name: t("airgate.design.s5.w3") as string, hint: t("airgate.design.s5.w3.hint") as string, image: TENT_IMAGES[3] },
    { id: "w4", name: t("airgate.design.s5.w4") as string, hint: t("airgate.design.s5.w4.hint") as string, image: TENT_IMAGES[4] },
  ];
  ...
  return (
    <QuestionScreen
      phase={t("airgate.design.s5.phase") as string}
      title={<>{t("airgate.design.s5.title")}</>}
      subtitle={t("airgate.design.s5.subtitle") as string}
    ...
    >
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <div className="font-syne font-bold text-[13px] text-white">{t("airgate.design.s5.extension.title") as string}</div>
          <div className="text-[11px] text-gray-400 mt-0.5 leading-relaxed">{t("airgate.design.s5.extension.hint") as string}</div>
        </div>
